...
RLAPI void DrawModelMaterial(Model model, Vector3 position, float scale, Material material, Color tint);
RLAPI void DrawModelEx(Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle, Vector3 scale, Color tint, Material *material); // Draw a model with extended parameters
